...
public class MainRecyclerAdapter extends FirebaseRecyclerAdapter<Product, MainRecyclerAdapter.ProductViewHolder>
{
    ...
    void setOnItemClickListener(MainRecyclerAdapter.OnItemClickListener listener)
    {
        MainRecyclerAdapter.listener = listener;
    }
     ...
     */
    MainRecyclerAdapter(@NonNull FirebaseRecyclerOptions<Product> options)
    {
        super(options);
    }
    ...
    @NonNull
    @Override
    public MainRecyclerAdapter.ProductViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType)
    {
